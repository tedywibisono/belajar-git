...
if(isset($_POST["register"])){
    if (register($_POST) > 0){
        echo "<div class='alert alert-success'>Regitrasi berhasil <a href='login.php'>Lihat data</a></div>";
    }else {
        echo"<div class='alert alert-danger'>gagal  registrasi </div>";
            ...
            <div class="row justify-content-center align-items-center h-100">
                <div class="col-6">
                    ...
                    <form action="" method="post">
                        ...
                        <button class="sign-in" name="register">sign up</button>
                    </form>
                        <button class="sign-in-google">
                        <img src="img/google.png" alt="">    
                        sign up with google</button>
                        <div class="text-center">
                            <span class="d-inline">Already have an account?<a href="login.php" class="d-inline">Sign in</a></span>
